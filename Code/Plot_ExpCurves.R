...
init50CALL<-ParamsData[137,4]
lam50CALL<-ParamsData[138,4]
#Create line layer to add to plot
...
jpeg("GenoLike_ShortComparisonPlot.jpg")
print(ReadPlot)
dev.off()

jpeg("GenoCall_ShortComparisonPlot.jpg")
print(CallPlot)
dev.off()
